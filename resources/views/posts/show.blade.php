                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            ...
                            <div class="blog-content">  
                                ...
                                <img src="{{ asset('assets/markedia/upload/market_blog_02.jpg') }}" alt="" class="img-fluid img-fullwidth">
                                ...
                                <div class="col-lg-12">
                                    <div class="banner-spot clearfix">
                                        <div class="banner-img">
                                            <img src="{{ asset('assets/markedia/upload/banner_01.jpg') }}" alt="" class="img-fluid">
                                        </div><!-- end banner-img -->
                                    </div><!-- end banner -->
                                </div><!-- end col -->
                            </div><!-- end row -->
                            ...
                            <div class="custombox authorbox clearfix">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        <img src="{{ asset('assets/markedia/upload/author.jpg') }}" alt="" class="img-fluid rounded-circle"> 
                                    </div><!-- end col -->
                                        ...
                                        <div class="comments-list">
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="{{ asset('assets/markedia/upload/author.jpg') }}" alt="" class="rounded-circle">
                                                </a>
                                            ...
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="{{ asset('assets/markedia/upload/author_01.jpg') }}" alt="" class="rounded-circle">
                                                </a>
                                                <div class="media-body">
                                            ...
                                            <div class="media last-child">
                                                <a class="media-left" href="#">
                                                    <img src="{{ asset('assets/markedia/upload/author_02.jpg') }}" alt="" class="rounded-circle">
                                                </a>
                                                <div class="media-body">
